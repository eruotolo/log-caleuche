                    ...
                    <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="uploads/<?php echo $row['image']?>" alt="" class="avatar-sm rounded-circle me-2">

                                    <a href="../admin/apps-contacts-profile-edit.php?id=<?php echo $row['id'] ?>" class="text-body"><?php echo $row['username'] ?></a>
                                </td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li><a class="dropdown-item" href="../admin/apps-contacts-profile-edit.php?id=<?php echo $row['id'] ?>">Editar</a></li>
